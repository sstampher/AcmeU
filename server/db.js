...
const syncAndSeed = async() => {
    ...
    const students = [{ firstName: 'Smooth', lastName: 'Poopie', gpa: 4.0, schoolId: NE.id }, { firstName: 'Mustang', lastName: 'Sally', gpa: 3.625, schoolId: CP.id }, { firstName: 'Stephanie', lastName: 'Stampher', gpa: 2.0, schoolId: UCLA.id }];
